...
echo Conetent-Type:text/xml
echo ""

echo $CONTENT_LENGTH >> /home/weiping/rec
echo $QUERY_STRING >> /home/weiping/rec
echo $PATH_INFO >> /home/weiping/rec
echo $REQUEST_METHOD >> /home/weiping/rec

#
#while read line ; do
#	echo $line >> /home/weiping/rec	
#	echo $line
#done
#

read var
echo $var >> /home/weiping/rec
